...
Cake.export_1_cake_to_html(cake01, "cakes_static.html")

# class method:
Cake.export_all_cakes_to_html = types.MethodType(
    export_all_cakes_to_html, Cake)
Cake.export_all_cakes_to_html('all_cakes.html')

# instance method:
for c in Cake.bakery_offer:
    c.export_this_cake_to_html = types.MethodType(export_this_cakes_to_html, c)
for c in Cake.bakery_offer:
    c.export_this_cake_to_html('thisCake.html')
