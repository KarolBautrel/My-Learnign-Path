class NoDuplicates:
    ...
    def __call__(self, cake, additives):
        ...
        no_duplicates = [i for i in additives if i not in cake.additives]
        self.funct(cake, no_duplicates)
...
cake01.show_info()
add_extra_additives(
    cake01, ['strawberries', 'sugar-flowers', 'chocolade', 'nuts', 'vanila'])
cake01.show_info()
add_extra_additives(
    cake01, ['strawberries', 'sugar-flowers', 'chocolade', 'nuts', 'vanila', 'oragne'])
cake01.show_info()
